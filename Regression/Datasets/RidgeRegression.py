# -*- coding: utf-8 -*-
"""
Created on Wed Mar 24 07:44:53 2021
...
#visualisiong the Ridge Regression results
...
#visualisiong the Ridge Regression for smoother curve results
X_grid = np.arange(min(X), max(X), 0.1)
X_grid = X_grid.reshape((len(X_grid), 1))
plt.scatter(X, y, color = 'red')
plt.plot(X_grid, regressor.predict(X_grid), color = 'blue')
plt.title('Ridge Regressio')
plt.xlabel('Level')
plt.ylabel('Salary')
plt.show()